...
export default function SacredChamber() {
  ...
  return (
    <View className={`min-h-screen bg-stone-950 ${isReady ? 'opacity-100' : 'opacity-0'}`}>
      ...
      >
        <View className="max-w-7xl mx-auto px-4 py-4 flex-row items-center justify-between">
          <TouchableOpacity onPress={navigateToHome}>
            <Text className="text-amber-400 font-serif text-xl">The Mirror Path</Text>
          </TouchableOpacity>
          
          {/* Desktop Navigation - Hidden on mobile */}
          <View className="hidden md:flex md:flex-row md:space-x-12 md:items-center">
          ...
          {/* Mobile Menu Button */}
          <TouchableOpacity onPress={toggleMobileMenu} className="md:hidden z-50">
            <View className={`w-6 h-0.5 bg-amber-400 mb-1.5 transform transition-transform ${mobileMenuOpen ? 'translate-y-2 rotate-45' : ''}`} />
            <View className={`w-6 h-0.5 bg-amber-400 mb-1.5 transition-opacity ${mobileMenuOpen ? 'opacity-0' : 'opacity-100'}`} />
            <View className={`w-6 h-0.5 bg-amber-400 transform transition-transform ${mobileMenuOpen ? '-translate-y-2 -rotate-45' : ''}`} />
          </TouchableOpacity>
        </View>
        
        {/* Mobile Navigation Menu */}
        {mobileMenuOpen && (
          <View className="absolute top-full left-0 right-0 bg-stone-950 border-t border-amber-900/30 py-4 px-4 md:hidden">
            <TouchableOpacity 
              onPress={() => handleMobileNavigation('overview')}
              className="py-3 border-b border-amber-900/20"
            >
              <Text className={`text-base ${activeSection === 'overview' ? 'text-amber-400' : 'text-amber-400/70'}`}>Overview</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              ...
              className="py-3 border-b border-amber-900/20"
            >
              <Text className={`text-base ${activeSection === 'journey' ? 'text-amber-400' : 'text-amber-400/70'}`}>The Journey</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              ...
              className="py-3 border-b border-amber-900/20"
            >
              <Text className={`text-base ${activeSection === 'testimonials' ? 'text-amber-400' : 'text-amber-400/70'}`}>Reflections</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              ...
              className="py-3 border-b border-amber-900/20"
            >
              <Text className={`text-base ${activeSection === 'readiness' ? 'text-amber-400' : 'text-amber-400/70'}`}>Your Readiness</Text>
            </TouchableOpacity>
            ...
            >
              <Text className="text-amber-300 text-base">Begin My Journey</Text>
            </TouchableOpacity>
          </View>
        )}
      </View>
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ flexGrow: 1 }} style={{ height: '100%' }}>
        ...
        <View className="h-screen relative overflow-hidden">
          ...
          <View className="absolute inset-0">
            <View className="absolute top-1/4 left-1/4 w-64 md:w-80 h-64 md:h-80 rounded-full bg-amber-500/10 blur-3xl animate-pulse-slow" style={{ animationDuration: '7s' }} />
            <View className="absolute bottom-1/4 right-1/4 w-64 md:w-80 h-64 md:h-80 rounded-full bg-amber-500/10 blur-3xl animate-pulse-slow" style={{ animationDuration: '10s', animationDelay: '2s' }} />
          </View>
          ...
          <View className="absolute inset-0 flex items-center justify-center">
            <View className="max-w-5xl px-6 text-center">
              <Text className="text-amber-300 text-xs sm:text-sm tracking-widest uppercase mb-4 sm:mb-6">
                A Sacred Invitation
              </Text>
              
              <Text className="text-amber-100 text-4xl sm:text-5xl md:text-7xl font-bold font-serif mb-4 sm:mb-8">
                The Sacred Chamber
              </Text>
              
              <Text className="text-amber-200 text-lg sm:text-xl md:text-2xl italic font-serif mb-6 sm:mb-12 max-w-3xl mx-auto">
                "Not everyone will feel the call. If you do — follow it."
              </Text>
              
              <Text className="text-amber-50 text-base sm:text-lg md:text-xl mb-8 sm:mb-12 max-w-2xl mx-auto">
              ...
              <View>
                ...
                >
                  ...
                  <Text className="text-white font-medium text-base sm:text-lg">Enter The Sacred Chamber</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
        ...
        {/* Overview Section */}
        <View id="overview" className="py-16 sm:py-24 md:py-32 px-4 relative bg-stone-950">
          ...
          <View className="max-w-5xl mx-auto relative z-10">
            <View className="mb-12 sm:mb-16 md:mb-20 text-center">
              <Text className="text-amber-400 text-base sm:text-lg mb-3 sm:mb-4">The Sacred Chamber is Unlike Any Other Space</Text>
              <Text className="text-amber-100 text-2xl sm:text-3xl md:text-4xl font-serif mb-4 sm:mb-6">
              ...
              <Text className="text-amber-200 text-sm sm:text-base max-w-2xl mx-auto mb-8 sm:mb-12">
                Trusted by transformational leaders, healers, and visionaries across the globe.
              </Text>
              
              <View className="flex flex-col md:flex-row items-center justify-center mb-8 sm:mb-12">
                <View className="w-24 h-24 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full overflow-hidden border-2 border-amber-700/30 shadow-lg mb-6 md:mb-0 md:mr-8">
                  <Image 
                ...
                <View className="max-w-xl text-center md:text-left">
                  <Text className="text-amber-100 text-lg sm:text-xl italic font-serif mb-2">
            ...
            <View className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16">
              <View className="bg-stone-900/50 p-5 sm:p-6 rounded-lg border border-amber-900/30">
                <Text className="text-amber-400 text-sm mb-3 sm:mb-4">The Container</Text>
                <Text className="text-amber-100 text-xl sm:text-2xl md:text-3xl font-serif mb-4 sm:mb-6">A Sacred Vessel for Your Becoming</Text>
                <Text className="text-amber-50 leading-relaxed mb-6 sm:mb-8">
                ...
                <View className="w-16 h-px bg-amber-700 my-4 sm:my-6" />
                
                <Text className="text-amber-50 italic mb-6 sm:mb-8">
                ...
                <View className="mt-6 sm:mt-10 space-y-4 sm:space-y-5">
              ...
              <View className="bg-stone-900/50 p-5 sm:p-6 rounded-lg border border-amber-900/30 mt-8 md:mt-0">
                <Text className="text-amber-400 text-sm mb-3 sm:mb-4">The Invitation</Text>
                <Text className="text-amber-100 text-xl sm:text-2xl md:text-3xl font-serif mb-4 sm:mb-6">Who The Chamber Calls</Text>
                <Text className="text-amber-50 leading-relaxed mb-4 sm:mb-6">
                ...
                <Text className="text-amber-300 italic mb-4 sm:mb-8 text-base sm:text-lg">
        ...
        {/* Journey Section */}
        <View id="journey" className="py-16 sm:py-24 md:py-32 px-4 relative bg-stone-900">
          ...
          <View className="absolute inset-0 flex items-center justify-center opacity-[0.03]">
            <Text className="text-amber-400 text-[300px] sm:text-[400px] md:text-[600px]">⊛</Text>
          </View>
          
          <View className="max-w-5xl mx-auto relative z-10">
            <View className="mb-12 sm:mb-16 md:mb-20 text-center">
              <Text className="text-amber-400 text-base sm:text-lg mb-3 sm:mb-4">The Transformational Path</Text>
              <Text className="text-amber-100 text-2xl sm:text-3xl md:text-4xl font-serif mb-6 sm:mb-12">
                Your Sacred Chamber Journey
              </Text>
              
              <View className="w-24 h-px bg-gradient-to-r from-amber-500/20 via-amber-500/80 to-amber-500/20 mx-auto mb-6 sm:mb-12" />
            </View>
            
            <View className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 md:gap-16 mb-16 sm:mb-20 md:mb-24">
              {journeyPhases.map((phase, index) => (
                <View key={index} className="border border-amber-900/30 rounded-lg p-6 sm:p-8 hover:border-amber-700/50 transition-all duration-500 bg-stone-900/30 hover:bg-stone-900/50">
                  <View className="mb-4 sm:mb-6 flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-amber-900/30 border border-amber-700/30">
                    <Text className="text-amber-400 text-xl sm:text-2xl">{phase.symbol}</Text>
                  </View>
                  <Text className="text-amber-100 text-lg sm:text-xl font-serif mb-2 sm:mb-3">{phase.name}</Text>
                  <Text className="text-amber-400/70 text-xs sm:text-sm mb-3 sm:mb-4">{phase.duration}</Text>
                  <Text className="text-amber-50 text-sm sm:text-base leading-relaxed">{phase.description}</Text>
                </View>
              ))}
            </View>
            
            <View className="text-center">
              <Text className="text-amber-100 text-xl sm:text-2xl font-serif mb-6 sm:mb-8">What You'll Receive</Text>
              
              <View className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 text-left">
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    <View className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-amber-900/30 border border-amber-700/30 flex items-center justify-center mr-3">
                      <Text className="text-amber-400 text-lg sm:text-xl">✧</Text>
                    </View>
                    <Text className="text-amber-400 text-base sm:text-lg">Sacred Ceremonies</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">10 private ceremonial sessions with personalized rituals and energy work</Text>
                </View>
                ...
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    ...
                    <Text className="text-amber-400 text-base sm:text-lg">Daily Practices</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">Custom-crafted rituals, meditations, and embodiment practices</Text>
                </View>
                ...
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    ...
                    <Text className="text-amber-400 text-base sm:text-lg">Sacred Connection</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">Voice message support and energetic holding throughout your journey</Text>
                </View>
                ...
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    ...
                    <Text className="text-amber-400 text-base sm:text-lg">Soul Library</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">Access to exclusive teachings, meditations, and wisdom transmissions</Text>
                </View>
                ...
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    ...
                    <Text className="text-amber-400 text-base sm:text-lg">Energy Clearings</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">Regular energetic clearings and sacred attunements</Text>
                </View>
                ...
                <View className="bg-stone-900/30 p-4 sm:p-6 rounded-lg border border-amber-800/20 mb-4 sm:mb-6 hover:border-amber-700/30 hover:bg-stone-900/50 transition-all duration-300">
                  <View className="flex items-center mb-3 sm:mb-4">
                    ...
                    <Text className="text-amber-400 text-base sm:text-lg">Completion Ceremony</Text>
                  </View>
                  <Text className="text-amber-50 text-sm sm:text-base">Sacred culmination ritual to honor your transformation</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View id="testimonials" className="py-16 sm:py-24 md:py-32 px-4 relative overflow-hidden bg-stone-950">
          <View className="absolute inset-0 bg-gradient-to-b from-stone-950 to-stone-900" />
          ...
          <View className="max-w-5xl mx-auto relative z-10">
            <View className="mb-12 sm:mb-16 md:mb-20 text-center">
              <Text className="text-amber-400 text-base sm:text-lg mb-3 sm:mb-4">Sacred Reflections</Text>
              <Text className="text-amber-100 text-2xl sm:text-3xl md:text-4xl font-serif mb-6 sm:mb-12">
            ...
            <View className="mb-12 sm:mb-16 md:mb-20 border-2 border-amber-700/30 rounded-xl p-6 sm:p-8 md:p-12 bg-gradient-to-br from-amber-900/20 to-stone-900/60 relative overflow-hidden">
              {/* Background decorative elements */}
              <View className="absolute top-5 left-6 opacity-20">
                <Text className="text-5xl sm:text-7xl md:text-9xl text-amber-400 font-serif">"</Text>
              </View>
              ...
              <View className="flex flex-col md:flex-row md:items-center">
                <View className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-2 border-amber-700/30 shadow-xl mx-auto md:mx-0 md:mr-10 relative mb-6 md:mb-0">
                  <Image 
                ...
                <View className="flex-1">
                  <Text className="text-amber-200 text-lg sm:text-xl md:text-2xl font-serif italic mb-6 sm:mb-8 leading-relaxed text-center md:text-left">
                  ...
                  <View className="w-16 h-px bg-gradient-to-r from-amber-600/50 to-amber-400/30 my-4 sm:my-6 mx-auto md:mx-0" />
                  
                  <View className="text-center md:text-left">
                    <Text className="text-amber-100 font-medium text-base sm:text-lg">Elena R.</Text>
            ...
            {/* Other testimonials */}
            <View className="space-y-8 sm:space-y-12 md:space-y-16">
              {testimonials.slice(1).map((testimonial, index) => (
                ...
                >
                  ...
                  <View className="absolute top-5 left-6 opacity-10">
                    <Text className="text-4xl sm:text-6xl md:text-9xl text-amber-800 font-serif">"</Text>
                  </View>
                  ...
                  <View className="relative z-10">
                    <Text className="text-amber-100 text-lg sm:text-xl md:text-2xl font-serif italic mb-6 sm:mb-8 leading-relaxed">
                      "{testimonial.quote}"
                    </Text>
                    
                    <View className="w-16 h-px bg-gradient-to-r from-amber-600/50 to-amber-400/30 my-6 sm:my-8" />
                    
                    <View className="flex flex-col sm:flex-row sm:items-center">
                      <View className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br from-amber-500/30 to-amber-700/30 mx-auto sm:mx-0 sm:mr-4 flex items-center justify-center mb-3 sm:mb-0">
                        <Text className="text-amber-400 text-lg sm:text-xl">{testimonial.name.charAt(0)}</Text>
                      </View>
        ...
        {/* Readiness Section */}
        <View id="readiness" className="py-16 sm:py-24 md:py-32 px-4 relative bg-stone-900">
          <View className="absolute inset-0 bg-gradient-to-b from-stone-900 to-stone-950" />
          
          <View className="max-w-5xl mx-auto relative z-10">
            <View className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
              <View className="bg-stone-900/50 p-6 rounded-lg border border-amber-900/30">
                <Text className="text-amber-400 text-base sm:text-lg mb-3 sm:mb-4">The Sacred Call</Text>
                <Text className="text-amber-100 text-xl sm:text-2xl md:text-3xl font-serif mb-4 sm:mb-8">
                  Is This Your Time?
                </Text>
                
                <Text className="text-amber-50 text-sm sm:text-base leading-relaxed mb-4 sm:mb-8">
                ...
                <Text className="text-amber-200 italic font-serif mb-8 sm:mb-12">
                ...
                >
                  <View className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all duration-700" />
                  <Text className="text-white font-medium text-base sm:text-lg">Begin Your Sacred Application</Text>
                </TouchableOpacity>
              </View>
              
              <View className="bg-stone-900/50 p-6 rounded-lg border border-amber-900/30 mt-8 md:mt-0">
                <Text className="text-amber-400 text-base sm:text-lg mb-3 sm:mb-4">Signs of Readiness</Text>
                <Text className="text-amber-100 text-xl sm:text-2xl md:text-3xl font-serif mb-4 sm:mb-8">
                  You May Be Called If...
                </Text>
                
                <View className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
                  {readinessChecklist.map((item, index) => (
                    <View key={index} className="flex-row items-start">
                      <Text className="text-amber-400 mr-3">✦</Text>
                      <Text className="text-amber-50 text-sm sm:text-base flex-1">{item}</Text>
                    </View>
                  ))}
                </View>
                
                <View className="border border-amber-800/30 rounded-lg p-5 sm:p-8 bg-stone-900/40">
                  <Text className="text-amber-100 text-base sm:text-lg font-serif mb-3 sm:mb-4">
                    Next Sacred Chamber Cycle
                  </Text>
                  <Text className="text-amber-50 text-sm sm:text-base mb-2">
                  ...
                  <Text className="text-amber-50 text-sm sm:text-base mb-4">
        ...
        <View className="py-16 sm:py-24 md:py-32 px-4 relative bg-stone-950">
          <View className="absolute inset-0 bg-gradient-to-b from-stone-950 via-stone-900 to-stone-950" />
          
          {/* Sacred ambient glow */}
          <View className="absolute inset-0">
            <View className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full bg-amber-600/5 blur-3xl" />
          </View>
          
          <View className="max-w-3xl mx-auto text-center relative z-10">
            <Text className="text-amber-300 italic font-serif mb-4 sm:mb-8 text-base sm:text-lg">
              "There is a place within you that already remembers."
            </Text>
          
            <Text className="text-amber-300 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif mb-6 sm:mb-10">
              The Chamber Awaits You
            </Text>
            
            <Text className="text-amber-100 text-base sm:text-lg md:text-xl mb-8 sm:mb-12 max-w-2xl mx-auto">
              If you've read this far, you've felt the resonance. Trust the call that brought you here.
            </Text>
            
            {/* Sacred bullet summary */}
            <View className="flex items-center justify-center mb-8 sm:mb-12">
              <View className="space-y-3 sm:space-y-4 inline-block text-left">
                <View className="flex-row items-center">
                  <Text className="text-amber-400 mr-3 text-base sm:text-xl">⊹</Text>
                  <Text className="text-amber-100 text-sm sm:text-base">5-month sacred container for profound transformation</Text>
                </View>
                <View className="flex-row items-center">
                  <Text className="text-amber-400 mr-3 text-base sm:text-xl">⊛</Text>
                  <Text className="text-amber-100 text-sm sm:text-base">Bi-monthly ceremonial sessions & continuous support</Text>
                </View>
                <View className="flex-row items-center">
                  <Text className="text-amber-400 mr-3 text-base sm:text-xl">✧</Text>
                  <Text className="text-amber-100 text-sm sm:text-base">Limited to 4 initiates per cycle. By invitation only.</Text>
                </View>
              </View>
            </View>
            ...
            <View>
              ...
              >
                ...
                <Text className="text-white font-medium text-lg sm:text-xl">Begin My Application</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
